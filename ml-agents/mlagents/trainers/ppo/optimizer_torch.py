...
class TorchPPOOptimizer(TorchOptimizer):
    def __init__(self, policy: TorchPolicy, trainer_settings: TrainerSettings):
        ...
        # (Get reward signals names and config from the trainer)
        ...
        # (if shared_critic is True, the critic is the same as the actor)
        ...
        # (initialize hyperparameters which are decayed over the training process)
        ...
        # (ADAM = optimized version of stochastic gradient descent)
        self.optimizer = torch.optim.Adam(
            params, lr=self.trainer_settings.hyperparameters.learning_rate
        )

        # (Used to track statistics of the training process)
    ...
    def update(self, batch: AgentBuffer, num_sequences: int) -> Dict[str, float]:
        ...
        # (Batch observations and actions from the buffer)
        ...
        # (Get outputs from the actor network)
        ...
        # (Network backpropagation and update steps)
