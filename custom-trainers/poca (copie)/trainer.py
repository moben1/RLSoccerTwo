...
class POCATrainer(OnPolicyTrainer):
    ...
    def _process_trajectory(self, trajectory: Trajectory) -> None:
        ...
        # Store the value and baseline estimates in the buffer (if using RNN)
        ...
        # (Add estimated rewards signals to the buffer)
        ...
        # (Add actual rewards signals to the trainer)
        ...
        # Get global advantages (mean of tmp advantages)
