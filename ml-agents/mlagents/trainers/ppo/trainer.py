...
class PPOTrainer(OnPolicyTrainer):
    ...
    def _process_trajectory(self, trajectory: Trajectory) -> None:
        ...
        # (Normalize network inputs for stability and convergence)
        if self.is_training:
        ...
        # (Values estimated by the critic network)
        (
            value_estimates,
            value_next,
            value_memories,
        ...
        # (RNN architectures Hidden state for example)
        ...
        # (Generalized Advantage Estimation (GAE) = how much better or worse an action is compared to the average action in a given state)
        # (Used to adjust the policy in policy gradient methods)
        tmp_advantages = []
        tmp_returns = []
        ...
        # (Get global advantages = mean of all advantages)
        ...
        # (Append to update buffer whose will be used in updating the model in optimizer class)
